...
public class Level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sound_info = MediaPlayer.create(this, R.raw.info);
        ...
        background.setBackgroundResource(R.drawable.level_5);
        ...
        previewImg.setImageResource(R.drawable.preview_img_5);

        // установка фона диалогового окна
        LinearLayout dialogFon = dialog.findViewById(R.id.dialog_fon);
        dialogFon.setBackgroundResource(R.drawable.preview_background_5);
        ...
        dialogFonEnd.setBackgroundResource(R.drawable.preview_background_5);
        ...
        imgLeft.setImageResource(array.image5[numLeft]);
        textLeft.setText(array.text5[numLeft]); //достаем из массива текст

        // генерировали значение для правой картики
        numRight = random.nextInt(20);
        while (array.choice2[numLeft] == array.choice2[numRight]) {
            numRight = random.nextInt(20);
        }
        imgRight.setImageResource(array.image5[numRight]);
        textRight.setText(array.text5[numRight]); //достаем из массива текст
        ...
        imgLeft.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (array.choice2[numLeft] > array.choice2[numRight]) {
                    ...
                    if (count == 20) { //выход из уровня
                        ...
                        numLeft = random.nextInt(20);
                        imgLeft.setImageResource(array.image5[numLeft]); //достаем из массива картьинку
                        ...
                        imgRight.setImageResource(array.image5[numRight]); //достаем из массива картьинку
