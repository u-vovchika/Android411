...
public class UniversalCARRADIO extends AppCompatActivity {
    ...
    private static final String KEY_RADIO = "srs";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_universal_carradio);
...
//                finish();// завершения процесса
                Intent intent = new Intent(UniversalCARRADIO.this, UniversalSet.class);
